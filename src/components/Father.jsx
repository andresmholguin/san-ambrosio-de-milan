  ...
  return (
    <div className="bg-white dark:bg-slate-800 w-full p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700/50 transition-all duration-300">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-lg font-bold text-slate-800 dark:text-white">Datos del Padre</h2>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="father-tipo-documento" className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1 block">
              Tipo de Documento
            </label>
            <select
              ...
              id="father-tipo-documento"
              {...register("father.tipoDocumento")}
            >
          ...
          <div>
            ...
            {errors.father?.documento && (
              <p className="text-red-500 dark:text-red-400 text-sm mt-1">{errors.father.documento.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              type="text"
              id="father-direccion"
              readOnly={watch("father.viveConHijo")}
