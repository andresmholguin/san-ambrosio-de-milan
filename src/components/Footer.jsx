    ...
    <footer className="w-full bg-[#1e293b] text-slate-300 dark:bg-slate-950 py-12 px-6 mt-16 border-t border-gray-200 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="text-xl font-bold text-white">Colegio San Ambrosio de Milán</h2>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-semibold text-slate-200 uppercase tracking-wider">Navegación</h3>
        ...
        <div className="flex flex-col gap-3 items-start md:items-end justify-between">
          <div className="flex gap-4">
            ...
            <svg className="w-6 h-6 text-slate-300 hover:text-white transition-colors cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-slate-700/50 text-center text-xs text-slate-400">
